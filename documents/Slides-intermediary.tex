...
\begin{frame}{Implemented solution}
    ...
    \end{itemize}
    \vfill
    \uncover<2->{Graphical web interface}
    \begin{itemize}
    ...
    \end{itemize}
    \vfill
    \uncover<0>{Regular network configuration backups}
\end{frame}

\begin{frame}{Interface}
    %\includegraphic[widht=400pt]{img/screenshot.jpg}
\end{frame}
...
\begin{frame}{Implemented solution}
    ...
    \end{itemize}
    \vfill
    \uncover<2>{Regular network configuration backups}
\end{frame}
